...
### Task One: 
- Found within task_one subfolder
- All Functionality located in file density.py
- May have to change paths for data files -- all located within read_csv()
- density.py
...
### Task Four:
- task_4.py
    - Function: center_approach_one(trajectories: Dict[str, List[Tuple[float, float]]]) -> List[Tuple[float, float]]
    ...
    - Function: center_approach_two(trajectories_dict: Dict[str, List[Tuple[float, float]]]) -> List[Tuple[float, float]]
        - Input: Dictionary with trajectory IDs as keys and lists of points as values
    ...
    - Function: calculate_distance(A: Tuple[float, float], B: Tuple[float, float]) -> float
    ...
    - Function: dtw(P: List[Tuple[float, float]], Q: List[Tuple[float, float]]) -> float
    ...
    - Function: TS_greedy(T: List[Tuple[float, float]], my_epsilon: float) -> List[Tuple[float, float]]
    ...
    - Function: read_trajectory_csv(file_name: str, ids_to_process: Set[str]) -> Dict[str, List[Tuple[float, float]]]
    ...
    - Function: read_trajectory_ids(file_name: str) -> List[str]
...
- task_5.py
    ...
    - Function: random_seeding(trajectories, k)
    ...
    - Function: random_lloyds(trajectories, k, t_max)
    ...
    - Function: evaluate_cost_optimized_PT2(trajectories)
    ...
    - Function: evaluate_cost_random_PT2(trajectories)
        - Input: A dictionary of trajectories
