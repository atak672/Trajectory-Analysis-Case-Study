...
# This file is simply a copy of code found in Task_Four folder
...
#             sums = (sums[0] + point[0], sums[1] + point[1])
#             counts += 1

#         avg_x, avg_y = sums[0] / counts, sums[1] / counts
#         central_trajectory.append((avg_x, avg_y))
...
if __name__ == "__main__":
    ...
    # print("Avg distance via approach II is: " + str(distance_2))
    ...
    # plt.plot([p[0] for p in approach_1], [p[1] for p in approach_1], label="Center Approach 1")
    ...
    approach_one_simp = center_approach_one(simplified_trajectories)
    ...
    distance_simp = 0
    for id in simplified_trajectories.keys():
        distance_simp += dtw(simplified_trajectories[id], approach_one_simp)
    print("Avg distance from center trajectory (simplified points)) is: " + str(distance_simp))
    ...
    # label = "Center Approach I:" + "Epsilon = " + str(ep)
    plt.plot([p[0] for p in approach_one_simp], [p[1] for p in approach_one_simp], '--', label='Center Approach I', linewidth = 3, )
    plt.legend()
